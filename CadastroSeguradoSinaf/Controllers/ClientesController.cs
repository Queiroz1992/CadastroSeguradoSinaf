using CadastroSeguradoSinaf.Models;
using System;
...
namespace CadastroSeguradoSinaf.Controllers
{
    public class ClientesController : Controller
    {
        ...
        private List<object> estados = new List<object>
        {
            ...
            new {Sigla = "MT", Nome = "Mato Grosso do Sul"},
            new {Sigla = "MS", Nome = "Minas Gerais"},
